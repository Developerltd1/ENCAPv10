...
namespace ENCAPv3.UI
{
    public partial class Dashboard : Form//BaseForm//Form//BasetForm
    {
        ...
        private void PollingTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                List<ChartValues<double>> ll = new MainParamatersForm().LoadModbusData(functionCode); // Load data function remains the same
                LoadModbusData(functionCode);                                                                   //AQIB
                DataTable ddt = MainParamatersForm.dt;
